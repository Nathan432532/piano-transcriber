...
TRANSCRIPTION_RUNNER_MODE = os.getenv("PIANO_TRANSCRIBER_RUNNER_MODE", "demo").strip() or "demo"
BASIC_PITCH_MODEL_PATH = os.getenv("PIANO_TRANSCRIBER_BASIC_PITCH_MODEL_PATH")
